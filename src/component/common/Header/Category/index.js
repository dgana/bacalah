          ...
          <div className="row">
            <div className="col-md-4" style={{display: 'flex', justifyContent: getJustify}}>
              { width < 600 ?
                ...
                width < 997 ?
                <Link to='/'>
                  <div style={{height: 110, width: 330, background: 'rgb(207,0,0)', padding: '20px 24px', borderRadius: 2}}>
                ...
                :
                <Link to='/'>
                  <div style={{height: 110, width: 330, background: 'rgb(207,0,0)', position: 'absolute', padding: '20px 24px', display: 'inline-block', borderRadius: 2}}>
                    <h1 className="site-logo" style={{fontFamily: 'bitter', letterSpacing: '-1px', fontSize: 42, color: 'rgb(250,250,250)', fontWeight: 1000}}>
                      Bacalah.co
                    </h1>
