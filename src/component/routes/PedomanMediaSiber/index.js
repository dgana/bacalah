              ...
              <div className={`col-md-12`}>
                <div className="widget">
                  ...
                  <div style={{fontSize: 14, lineHeight: '30px'}}>
                    ...
                    <p>Media siber memiliki karakter khusus sehingga memerlukan pedoman agar pengelolaannya dapat dilaksanakan secara profesional,
                      memenuhi fungsi, hak, dan kewajibannya sesuai Undang-Undang Nomor 40 Tahun 1999 tentang Pers dan Kode Etik Jurnalistik.
                    ...
                    <p style={{fontWeight: 'bolder', fontSize: 22}}>1. Ruang Lingkup</p>
                    ...
                    <br />
                    <p style={{fontWeight: 'bolder', fontSize: 22}}>2. Verifikasi dan keberimbangan berita</p>
                    ...
                    <br />
                    <p style={{fontWeight: 'bolder', fontSize: 22}}>3. Isi Buatan Pengguna (User Generated Content)</p>
                    ...
                    <br />
                    <p style={{fontWeight: 'bolder', fontSize: 22}}>4. Ralat, Koreksi, dan Hak Jawab</p>
                    ...
                    <br />
                    <p style={{fontWeight: 'bolder', fontSize: 22}}>5. Pencabutan Berita</p>
                    ...
                    <br />
                    <p style={{fontWeight: 'bolder', fontSize: 22}}>6. Iklan</p>
